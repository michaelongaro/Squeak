...
function Board() {
  ...
  return (
    <div
      ...
      className={`${classes.board} grid w-full select-none grid-cols-5 gap-2 rounded-md bg-gradient-to-br from-green-800 to-green-850 bg-fixed p-2 mobileLarge:gap-4 desktop:gap-1`}
    >
