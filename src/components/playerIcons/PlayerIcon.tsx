...
function PlayerIcon({
  ...
  const expandedMargin = animatePresence
    ...
    <>
      {avatarPath && borderColor && (
        <motion.div
          ...
          // layout-affecting animation (size + margin)
          initial={{
            width: animatePresence ? 0 : "auto",
            height: animatePresence ? 0 : "auto",
            margin: animatePresence ? expandedMargin : 0,
          }}
          animate={{
            width: "auto",
            height: "auto",
            ...
            transition: {
              width: { duration: SIZE_DUR, ease: "easeOut" },
              height: { duration: SIZE_DUR, ease: "easeOut" },
              margin: { duration: SIZE_DUR, ease: "easeOut" },
            },
          }}
          exit={{
            width: 0,
            ...
            margin: 0,
            transition: {
              // wait for inner fade to finish, then collapse size
              width: { duration: SIZE_DUR, ease: "easeOut", delay: FADE_DUR },
              height: { duration: SIZE_DUR, ease: "easeOut", delay: FADE_DUR },
              margin: { duration: SIZE_DUR, ease: "easeOut", delay: FADE_DUR },
            },
          }}
          style={{
            ...style,
          ...
          className={`baseVertFlex shrink-0 ${
            forWhilePlayingSheet ? "text-darkGreen" : "text-lightGreen"
          }`}
        >
          <motion.div
            initial={{
            ...
            animate={{
              ...
              scale: 1,
              transition: {
                // size first, then reveal
                delay: animatePresence ? 0.25 : 0,
                duration: 0.12,
                ease: "easeOut",
              },
            }}
