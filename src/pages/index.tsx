  ...
  return (
    ...
    >
      {isSignedIn !== undefined && (
        <div className="baseVertFlex w-[17.5rem] rounded-md border-2 border-white bg-gradient-to-br from-green-800 to-green-900 py-4 shadow-lg lg:w-[22.25rem] mobileLarge:p-4 desktop:p-8">
          <Image
            src={logo}
            alt="Squeak logo"
            priority={true}
